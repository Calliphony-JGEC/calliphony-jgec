    ...
    return (
        <header className={`admin-header ${scrolled ? 'admin-header--scrolled' : ''}`}>
            <div className="admin-header-inner">
                <a href="/" onClick={handleLogoClick} className="nav-logo" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
                ...
                <ul className="nav-links">
                    <li><a href="/admin/upload" onClick={(e) => handleAdminNavClick(e, 'upload')} className="nav-link-item"><span>Uploads</span></a></li>
